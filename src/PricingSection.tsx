...
function PricingSection() {
  return (
    <section className='bg-black w-full flex flex-col items-center p-8'>
      <h2 className='text-white text-5xl font-bold my-10 text-center'>The <span className='bg-linear-to-r from-[#2B9AB5] to-[#01af49] text-transparent bg-clip-text'>Perfect Plan</span>  for Your Needs</h2>
